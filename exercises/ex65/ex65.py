...
stream_mins = input_stream.map(stream_map).reduceByKeyAndWindow(lambda v1, v2: min(v1, v2), None, 60)
stream_maxs = input_stream.map(stream_map).reduceByKeyAndWindow(lambda v1, v2: max(v1, v2), None, 60)
